...
class TestSingleTarget:
    ...
    def test_poisoned_stab_base(self, game):
    ...
    def test_poisoned_stab_upgraded(self, game):
    ...
    def test_poisoned_stab_with_strength(self, game):
    ...
    def test_dagger_throw_base(self, game):
    ...
    def test_dagger_throw_upgraded(self, game):
    ...
    def test_sneaky_strike_no_discard(self, game):
    ...
    def test_sneaky_strike_upgraded(self, game):
    ...
    def test_slice_base_no_shiv(self, game):
    ...
    def test_backflip_base(self, game):
    ...
    def test_backflip_upgraded(self, game):
    ...
    def test_dodge_and_roll_self(self, game):
    ...
    def test_deflect_base_no_shiv(self, game):
    ...
    def test_cloak_and_dagger_base(self, game):
    ...
    def test_cloak_and_dagger_upgraded(self, game):
    ...
    def test_blade_dance_base(self, game):
    ...
    def test_blade_dance_upgraded(self, game):
    ...
    def test_blade_dance_stacks(self, game):
    ...
    def test_prepared_base(self, game):
    ...
    def test_prepared_upgraded(self, game):
    ...
    def test_deadly_poison_base(self, game):
    ...
    def test_deadly_poison_stacks(self, game):
    ...
    def test_deadly_poison_upgraded(self, game):
    ...
    def test_acrobatics_base(self, game):
    ...
    def test_acrobatics_upgraded(self, game):
    ...
    def test_accuracy_upgraded_costs_zero(self, game):
    ...
    def test_after_image_upgraded_costs_zero(self, game):
...
class TestAOE:
    ...
    def test_dagger_spray_base(self, game):
    ...
    def test_dagger_spray_upgraded(self, game):
    ...
    def test_dagger_spray_with_strength(self, game):

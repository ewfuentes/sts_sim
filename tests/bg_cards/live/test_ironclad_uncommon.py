...
class TestSingleTarget:
    ...
    def test_uppercut_base(self, game):
    ...
    def test_uppercut_with_strength(self, game):
    ...
    def test_uppercut_upgraded(self, game):
    ...
    def test_entrench_doubles_block(self, game):
    ...
    def test_entrench_block_cap(self, game):
    ...
    def test_entrench_zero_block(self, game):
    ...
    def test_entrench_upgraded_no_exhaust(self, game):
    ...
    def test_whirlwind_zero_energy(self, game):
    ...
    def test_whirlwind_upgraded(self, game):
    ...
    def test_whirlwind_with_strength(self, game):
    ...
    def test_battle_trance_base(self, game):
    ...
    def test_battle_trance_upgraded(self, game):
    ...
    def test_burning_pact_base(self, game):
    ...
    def test_burning_pact_upgraded(self, game):
    ...
    def test_carnage_base(self, game):
    ...
    def test_carnage_upgraded(self, game):
    ...
    def test_blood_for_blood_full_cost(self, game):
    ...
    def test_disarm_base(self, game):
    ...
    def test_disarm_upgraded(self, game):
    ...
    def test_disarm_stacks(self, game):
    ...
    def test_ghostly_armor_base(self, game):
    ...
    def test_ghostly_armor_upgraded(self, game):
    ...
    def test_inflame_base(self, game):
    ...
    def test_inflame_stacks(self, game):
    ...
    def test_inflame_upgraded(self, game):
    ...
    def test_power_through_base(self, game):
    ...
    def test_power_through_upgraded(self, game):
    ...
    def test_second_wind_base(self, game):
    ...
    def test_second_wind_only_attacks(self, game):
    ...
    def test_second_wind_upgraded(self, game):
    ...
    def test_sentinel_base(self, game):
    ...
    def test_sentinel_energy_on_exhaust(self, game):
    ...
    def test_sever_soul_base(self, game):
    ...
    def test_sever_soul_with_strength(self, game):
    ...
    def test_spot_weakness_valid(self, game):
    ...
    def test_rage_no_attacks(self, game):
    ...
    def test_rage_upgraded(self, game):
    ...
    def test_combust_base(self, game):
    ...
    def test_dark_embrace_upgraded(self, game):
    ...
    def test_evolve_upgraded(self, game):
    ...
    def test_feel_no_pain_upgraded(self, game):
    ...
    def test_fire_breathing_base(self, game):
    ...
    def test_rupture_base(self, game):
    ...
    def test_rupture_stacks(self, game):
    ...
    def test_rupture_upgraded(self, game):
...
class TestAOE:
    ...
    def test_shockwave_base(self, game):
    ...
    def test_shockwave_upgraded(self, game):
    ...
    def test_whirlwind_spends_all_energy(self, game):
...
class TestMultiTurn:
    ...
    def test_metallicize_end_of_turn(self, game):
        """Metallicize grants block at end of turn; verify turn transition matches."""
        hand = [sts_sim.Card.StrikeRed] * 5
        draw = [sts_sim.Card.DefendRed] * 5

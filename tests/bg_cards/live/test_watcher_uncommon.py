...
def test_crush_joints_neutral(game):
...
def test_crush_joints_in_wrath(game):
...
def test_crush_joints_upgraded_wrath(game):
...
def test_fear_no_evil_neutral(game):
...
def test_fear_no_evil_wrath(game):
...
def test_foreign_influence_basic(game):
...
def test_sash_whip_neutral(game):
...
def test_carve_reality_single(game):
...
def test_sands_of_time_basic(game):
...
def test_windmill_strike_base(game):
...
def test_wallop_enemy_block(game):
...
def test_signature_move_only_attack(game):
...
def test_reach_heaven_basic(game):
...
def test_empty_mind_draws(game):
...
def test_inner_peace_neutral(game):
...
def test_indignation_neutral(game):
...
def test_perseverance_base(game):
...
def test_wreath_of_flame_x_cost(game):
...
def test_battle_hymn_play(game):
...
def test_simmering_fury_play(game):
...
def test_mental_fortress_play(game):

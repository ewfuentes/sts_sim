...
class TestSingleTarget:
    ...
    def test_bludgeon_base(self, game):
    ...
    def test_bludgeon_upgraded(self, game):
    ...
    def test_bludgeon_with_strength(self, game):
    ...
    def test_impervious_base(self, game):
    ...
    def test_impervious_upgraded(self, game):
    ...
    def test_impervious_stacks(self, game):
    ...
    def test_offering_base(self, game):
    ...
    def test_offering_upgraded(self, game):
    ...
    def test_barricade_base(self, game):
    ...
    def test_barricade_upgraded(self, game):
    ...
    def test_berserk_base(self, game):
    ...
    def test_corruption_base(self, game):
    ...
    def test_corruption_upgraded(self, game):
    ...
    def test_demon_form_base(self, game):
    ...
    def test_demon_form_upgraded(self, game):
    ...
    def test_double_tap_base(self, game):
    ...
    def test_double_tap_upgraded(self, game):
    ...
    def test_feed_no_kill(self, game):
    ...
    def test_fiend_fire_base(self, game):
    ...
    def test_fiend_fire_empty_hand(self, game):
    ...
    def test_fiend_fire_upgraded(self, game):
    ...
    def test_fiend_fire_with_strength(self, game):
    ...
    def test_immolate_with_strength(self, game):
    ...
    def test_juggernaut_on_block_gain(self, game):
    ...
    def test_limit_break_base(self, game):
    ...
    def test_limit_break_cap(self, game):
    ...
    def test_limit_break_zero_str(self, game):
    ...
    def test_limit_break_upgraded(self, game):
...
class TestAOE:
    ...
    def test_immolate_base(self, game):
    ...
    def test_immolate_upgraded(self, game):

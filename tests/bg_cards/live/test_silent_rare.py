...
def test_die_die_die_upgraded(game):
...
def test_die_die_die_with_strength(game):
...
def test_grand_finale_empty_draw(game):
...
def test_grand_finale_upgraded(game):
...
def test_grand_finale_with_strength(game):
...
def test_skewer_with_3_energy(game):
...
def test_skewer_with_0_energy(game):
...
def test_skewer_upgraded_with_3_energy(game):
...
def test_skewer_with_strength(game):
...
def test_adrenaline_basic(game):
...
def test_adrenaline_as_turn_starter(game):
...
def test_bullet_time_basic(game):
...
def test_bullet_time_upgraded(game):
    """Bullet Time+ costs 2."""
    hand = [
...
def test_malaise_with_3_energy(game):
...
def test_malaise_with_1_energy(game):
...
def test_malaise_upgraded_with_2_energy(game):
...
def test_corpse_explosion_applies_poison(game):
...
def test_corpse_explosion_upgraded(game):
...
def test_a_thousand_cuts_plays(game):
...
def test_burst_doubles_next_skill(game):
...
def test_burst_upgraded_costs_0(game):
...
def test_burst_does_not_double_attacks(game):
...
def test_envenom_adds_poison(game):
...
def test_envenom_upgraded_costs_2(game):
...
def test_tools_of_the_trade_plays(game):
...
def test_tools_of_the_trade_upgraded(game):
...
def test_wraith_form_plays(game):

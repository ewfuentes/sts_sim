...
def test_anger_base_damage_and_draw_pile(game):
...
def test_anger_with_strength(game):
...
def test_body_slam_zero_block(game):
...
def test_body_slam_upgraded_costs_zero(game):
...
def test_body_slam_with_strength(game):
...
def test_clash_all_attacks_playable(game):
...
def test_cleave_base_hits_all_enemies(game):
...
def test_cleave_upgraded_hits_all_enemies(game):
...
def test_cleave_with_strength(game):
...
def test_clothesline_base_damage_and_weak(game):
...
def test_clothesline_upgraded_damage_and_weak(game):
...
def test_clothesline_with_strength(game):
...
def test_heavy_blade_base_no_strength(game):
...
def test_heavy_blade_with_strength_triples(game):
...
def test_heavy_blade_upgraded_quintuples(game):
...
def test_iron_wave_base_damage_and_block(game):
...
def test_iron_wave_with_strength(game):
...
def test_iron_wave_upgraded_choice(game):
...
def test_perfected_strike_no_other_strikes(game):
...
def test_perfected_strike_with_two_strikes(game):
...
def test_perfected_strike_upgraded_with_two_strikes(game):
...
def test_pommel_strike_base_damage_and_draw(game):
...
def test_pommel_strike_upgraded_draws_two(game):
...
def test_pommel_strike_empty_draw_reshuffle(game):
...
def test_shrug_it_off_base_block_and_draw(game):
...
def test_shrug_it_off_stacks_with_existing_block(game):
...
def test_twin_strike_base_two_hits(game):
...
def test_twin_strike_against_block(game):
...
def test_twin_strike_upgraded(game):
...
def test_twin_strike_with_strength(game):
...
def test_wild_strike_base_damage_and_dazed(game):
...
def test_headbutt_base_damage_and_moves_discard(game):
...
def test_headbutt_empty_discard(game):
...
def test_havoc_draws_plays_and_exhausts(game):
...
def test_havoc_upgraded_costs_zero(game):
...
def test_seeing_red_base_grants_energy(game):
...
def test_seeing_red_upgraded_costs_zero(game):
...
def test_true_grit_base_block_and_exhaust(game):
...
def test_true_grit_only_card_in_hand(game):
...
def test_warcry_base_draws_two_puts_one_back_exhausts(game):
...
def test_warcry_upgraded_draws_three(game):

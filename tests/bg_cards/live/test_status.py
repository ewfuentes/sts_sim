...
class TestCards:
    ...
    def test_slimed_plays_and_costs_energy(self, game):
    ...
    def test_dazed_in_hand_with_playable(self, game):
    ...
    def test_burn_in_hand_with_playable(self, game):
    ...
    def test_void_card_draw_energy_loss(self, game):
    ...
    def test_desync_unplayable(self, game):
        """Desync cannot be played (error indicator card)."""
        pass

    @pytest.mark.skip(reason="Desync not implemented in simulator")
    def test_desync_clogs_hand(self, game):

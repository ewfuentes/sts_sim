...
class TestCards:
    ...
    def test_ball_lightning_damage_and_channel(self, game):
    ...
    def test_ball_lightning_upgraded_deals_2(self, game):
    ...
    def test_ball_lightning_full_orb_slots(self, game):
    ...
    def test_barrage_hits_per_orb(self, game):
    ...
    def test_barrage_no_orbs(self, game):
    ...
    def test_barrage_upgraded_extra_hit(self, game):
    ...
    def test_barrage_with_strength(self, game):
    ...
    def test_beam_cell_vuln_on_low_roll(self, game):
    ...
    def test_beam_cell_upgraded_always_vuln(self, game):
    ...
    def test_claw_base_no_bonus(self, game):
    ...
    def test_claw_bonus_from_cost_0_discard(self, game):
    ...
    def test_claw_upgraded_bonus(self, game):
    ...
    def test_claw_bonus_stacks_with_strength(self, game):
    ...
    def test_compile_driver_draws_per_unique_orb(self, game):
    ...
    def test_compile_driver_no_orbs(self, game):
    ...
    def test_compile_driver_upgraded(self, game):
    ...
    def test_go_for_the_eyes_no_weak_on_low_roll(self, game):
    ...
    def test_go_for_the_eyes_upgraded_always_weak(self, game):
    ...
    def test_sweeping_beam_aoe_and_draw(self, game):
    ...
    def test_sweeping_beam_upgraded(self, game):
    ...
    def test_sweeping_beam_with_strength(self, game):
    ...
    def test_charge_battery_block_no_energy(self, game):
    ...
    def test_charge_battery_block_and_energy(self, game):
    ...
    def test_charge_battery_upgraded(self, game):
    ...
    def test_chaos_channels_lightning(self, game):
    ...
    def test_chaos_upgraded_costs_0(self, game):
    ...
    def test_coolheaded_channels_frost(self, game):
    ...
    def test_coolheaded_upgraded_draws(self, game):
    ...
    def test_coolheaded_full_orb_slots(self, game):
    ...
    def test_leap_block_to_self(self, game):
    ...
    def test_leap_upgraded_block(self, game):
    ...
    def test_recursion_evokes_and_rechannels_lightning(self, game):
    ...
    def test_recursion_evokes_frost(self, game):
    ...
    def test_recursion_upgraded_costs_0(self, game):
    ...
    def test_recursion_no_orbs(self, game):
    ...
    def test_steam_barrier_base_no_bonus(self, game):
    ...
    def test_steam_barrier_bonus_from_cost_0(self, game):
    ...
    def test_steam_barrier_upgraded_bonus(self, game):
    ...
    def test_steam_barrier_empty_discard(self, game):

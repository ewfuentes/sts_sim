...
def test_strike_green_base(game):
...
def test_strike_green_with_strength(game):
...
def test_strike_green_upgraded(game):
...
def test_defend_green_base(game):
...
def test_defend_green_upgraded_stack_on_self(game):
...
def test_neutralize_with_strength(game):
...
def test_neutralize_upgraded(game):
...
def test_survivor_upgraded(game):

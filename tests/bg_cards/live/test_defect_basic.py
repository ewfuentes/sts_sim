...
class TestCards:
    ...
    def test_strike_blue_base_damage(self, game):
    ...
    def test_strike_blue_with_strength(self, game):
    ...
    def test_strike_blue_upgraded_costs_0(self, game):
    ...
    def test_defend_blue_base_block(self, game):
    ...
    def test_defend_blue_stacks_with_existing_block(self, game):
    ...
    def test_zap_channels_lightning(self, game):
    ...
    def test_zap_evokes_oldest_when_full(self, game):
    ...
    def test_zap_upgraded_costs_0(self, game):
    ...
    def test_dualcast_evokes_lightning_twice(self, game):
    ...
    def test_dualcast_evokes_frost_twice(self, game):
    ...
    def test_dualcast_upgraded_costs_0(self, game):
    ...
    def test_dualcast_no_orbs(self, game):

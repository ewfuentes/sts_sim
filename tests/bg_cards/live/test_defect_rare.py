...
class TestCards:
    ...
    def test_all_for_one_retrieves_zero_cost(self, game):
    ...
    def test_all_for_one_upgraded(self, game):
    ...
    def test_core_surge_base(self, game):
    ...
    def test_hyperbeam_base(self, game):
    ...
    def test_hyperbeam_no_orbs(self, game):
    ...
    def test_hyperbeam_upgraded(self, game):
    ...
    def test_thunder_strike_with_lightning(self, game):
    ...
    def test_thunder_strike_no_lightning(self, game):
    ...
    def test_fission_with_orbs(self, game):
    ...
    def test_fission_no_orbs(self, game):
    ...
    def test_rainbow_channels_3_orbs(self, game):
    ...
    def test_rainbow_upgraded_no_exhaust(self, game):
    ...
    def test_skim_upgraded(self, game):
    ...
    def test_electrodynamics_channels_2(self, game):
    ...
    def test_electrodynamics_upgraded(self, game):
    ...
    def test_defragment_base(self, game):
    ...
    def test_static_discharge_base(self, game):
    ...
    def test_buffer_base(self, game):
    ...
    def test_echo_form_base(self, game):
    ...
    def test_amplify_base(self, game):

...
class TestCards:
    ...
    def test_blizzard_base(self, game):
    ...
    def test_blizzard_no_frost(self, game):
    ...
    def test_blizzard_upgraded(self, game):
    ...
    def test_cold_snap_base(self, game):
    ...
    def test_cold_snap_upgraded(self, game):
    ...
    def test_doom_and_gloom_base(self, game):
    ...
    def test_doom_and_gloom_upgraded(self, game):
    ...
    def test_ftl_first_card(self, game):
    ...
    def test_ftl_upgraded(self, game):
    ...
    def test_melter_removes_block(self, game):
    ...
    def test_melter_no_block(self, game):
    ...
    def test_melter_upgraded(self, game):
    ...
    def test_scrape_zero_cost_top(self, game):
    ...
    def test_scrape_empty_discard(self, game):
    ...
    def test_streamline_no_powers(self, game):
    ...
    def test_streamline_upgraded(self, game):
    ...
    def test_sunder_no_kill(self, game):
    ...
    def test_darkness_base(self, game):
    ...
    def test_darkness_upgraded(self, game):
    ...
    def test_double_energy_base(self, game):
    ...
    def test_double_energy_upgraded(self, game):
    ...
    def test_equilibrium_block(self, game):
    ...
    def test_equilibrium_upgraded_block(self, game):
    ...
    def test_glacier_base(self, game):
    ...
    def test_hologram_retrieves_and_exhausts(self, game):
    ...
    def test_hologram_upgraded_no_exhaust(self, game):
    ...
    def test_overclock_base(self, game):
    ...
    def test_overclock_upgraded(self, game):
    ...
    def test_reprogram_base(self, game):
    ...
    def test_reprogram_upgraded(self, game):
    ...
    def test_stack_with_orbs(self, game):
    ...
    def test_stack_upgraded(self, game):
    ...
    def test_turbo_upgraded(self, game):
    ...
    def test_reinforced_body_x1(self, game):
    ...
    def test_capacitor_base(self, game):
    ...
    def test_capacitor_upgraded(self, game):
    ...
    def test_consume_base(self, game):
    ...
    def test_consume_upgraded(self, game):
    ...
    def test_fusion_base(self, game):
    ...
    def test_fusion_upgraded(self, game):
    ...
    def test_heatsinks_base(self, game):
    ...
    def test_machine_learning_base(self, game):
    ...
    def test_machine_learning_upgraded(self, game):

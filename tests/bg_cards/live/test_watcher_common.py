...
class TestCards:
    ...
    def test_flurry_of_blows_no_stance_switch(self, game):
    ...
    def test_flurry_of_blows_with_stance_switch(self, game):
    ...
    def test_flurry_of_blows_upgraded_with_stance_switch(self, game):
    ...
    def test_empty_fist_from_wrath(self, game):
    ...
    def test_empty_fist_from_calm(self, game):
    ...
    def test_empty_fist_upgraded(self, game):
    ...
    def test_empty_fist_from_neutral(self, game):
    ...
    def test_consecrate_aoe(self, game):
    ...
    def test_consecrate_in_wrath(self, game):
    ...
    def test_consecrate_upgraded(self, game):
    ...
    def test_cut_through_fate_base(self, game):
    ...
    def test_cut_through_fate_upgraded(self, game):
    ...
    def test_cut_through_fate_in_wrath(self, game):
    ...
    def test_just_lucky_base(self, game):
    ...
    def test_flying_sleeves_base(self, game):
    ...
    def test_flying_sleeves_upgraded(self, game):
    ...
    def test_flying_sleeves_with_strength(self, game):
    ...
    def test_empty_body_from_wrath(self, game):
    ...
    def test_empty_body_from_calm(self, game):
    ...
    def test_empty_body_upgraded(self, game):
    ...
    def test_protect_base(self, game):
    ...
    def test_protect_upgraded(self, game):
    ...
    def test_halt_neutral(self, game):
    ...
    def test_halt_in_wrath(self, game):
    ...
    def test_halt_upgraded_in_wrath(self, game):
    ...
    def test_halt_in_calm(self, game):
    ...
    def test_third_eye_base(self, game):
    ...
    def test_third_eye_upgraded(self, game):
    ...
    def test_tranquility_base(self, game):
    ...
    def test_tranquility_upgraded(self, game):
    ...
    def test_tranquility_from_wrath(self, game):
    ...
    def test_crescendo_base(self, game):
    ...
    def test_crescendo_from_calm(self, game):
    ...
    def test_crescendo_upgraded_draws(self, game):
    ...
    def test_collect_base(self, game):
    ...
    def test_collect_upgraded(self, game):

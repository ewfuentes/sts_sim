...
def test_eruption_from_calm(game):
...
def test_eruption_upgraded(game):
...
def test_eruption_in_wrath(game):
...
def test_vigilance_upgraded(game):
...
def test_vigilance_from_wrath(game):
...
def test_vigilance_already_in_calm(game):
